                            ...
                            <div class="row">
                                @forelse($packages as $package)
                                    <div class="col-md-6 mb-3">
                                        <div class="package-card border rounded p-3 {{ old('spa_package_id') == $package->id ? 'border-primary bg-light' : '' }}"
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="spa_package_id" 
                                                    ...
                                                    {{ old('spa_package_id') == $package->id ? 'checked' : '' }}
                                                    required>
                                                <label class="form-check-label w-100" for="package_{{ $package->id }}">
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <span class="badge bg-info">{{ $package->duration_minutes }} min</span>
