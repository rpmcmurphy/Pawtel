@if (session('success'))
    <div class="alert alert-success alert-dismissible fade show pawtel-alert" role="alert">
...
@if (session('error'))
    <div class="alert alert-danger alert-dismissible fade show pawtel-alert" role="alert">
...
@if (session('warning'))
    <div class="alert alert-warning alert-dismissible fade show pawtel-alert" role="alert">
...
@if (session('info'))
    <div class="alert alert-info alert-dismissible fade show pawtel-alert" role="alert">
